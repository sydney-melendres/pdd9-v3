...
output_path = 'processes\logs\start.log'
...
subprocess.run(['python', 'processes\py\start_again.py'])

time.sleep(5)

subprocess.run(['python', 'processes\py\create_df.py'])

time.sleep(5)

subprocess.run(['python', 'processes\py\offset_points.py'])
